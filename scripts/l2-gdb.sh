...
gdbserver :1234 qemu-system-aarch64 -serial /dev/hvc1 -monitor /dev/hvc2 \
    ...
    -kernel $IMAGE_PATH -initrd $ROOTFS_PATH -append 'rcu_cpu_stall_timeout=0 nokaslr earlycon console=ttyAMA0 rdinit=/sbin/init' \
    -nographic \
